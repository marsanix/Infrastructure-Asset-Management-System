...
<template>
  <MasterListView ref="listRef" title="Categories" endpoint="/categories"
    permission-module="category" :columns="columns"
    :on-create-click="openCreate" :on-edit-click="openEdit" />

  <MasterFormModal :open="modal" :title="editTarget ? 'Edit Category' : 'Create Category'"
